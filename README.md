# PieceMotoOccasion marketplace pour WooCommerce

Vendez vos pièces moto sur la marketplace française [PieceMotoOccasion](https://piecemotooccasion.eu) depuis votre boutique WooCommerce.
...
**Page et guide d'installation** : https://piecemotooccasion.eu/extensions/woocommerce
...
2. WooCommerce › PieceMotoOccasion : jeton API (espace vendeur) et catégorie par défaut ; la première catégorie WooCommerce du produit est envoyée quand elle existe.
3. Copier l'URL de notification affichée (`.../wp-json/piecemoto/v1/commande`) dans votre espace vendeur.
